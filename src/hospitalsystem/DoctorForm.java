...
public class DoctorForm extends JFrame {
	...
	JLabel lblNewLabel_2 = new JLabel("Enter Doctor phoneno");
	...
	JLabel lblNewLabel_3 = new JLabel("Enter Doctor address");
...
d.setschedule(textField_3.getText());

Random rand=new Random();

PersonIDFactory ids=new PersonIDFactory();  //using Factory pattern
String id=ids.getPersonID("Doctor");
d.setId(rand.nextInt(100)+id);

HospitalSystem.ml.addDoctor(d);
JOptionPane.showMessageDialog(null, "Doctor Added Successfully with ID "+d.getId());
...
dispose();
	...
	JLabel lblNewLabel_4 = new JLabel("Add Doctor To System");
	lblNewLabel_4.setForeground(Color.WHITE);
	lblNewLabel_4.setFont(new Font("Trebuchet MS", Font.BOLD, 27));
	lblNewLabel_4.setBounds(181, 26, 296, 62);
	getContentPane().add(lblNewLabel_4);
	
	JLabel lblNewLabel_3_1 = new JLabel("Enter Doctor schedule");
